...
$(function() {
    ...
    $("#swal-1").on("click", function() {
        e.fire("Any fool can use a computer")
    }), $("#swal-2").on("click", function() {
        e.fire("The Internet?", "That thing is still around?", "question")
        ...
        e.fire({
            ...
            t.value ? swalWithBootstrapButtons.fire("Deleted!", "Your file has been deleted.", "success") : t.dismiss === Swal.DismissReason.cancel && swalWithBootstrapButtons.fire("Cancelled", "Your imaginary file is safe :)", "error")
        })
        ...
        e.fire({
            ...
            preConfirm: function(t) {
                return fetch("https://api.github.com/users/".concat(t)).then(function(t) {
        ...
        e.mixin({
            ...
            t.value && (t = JSON.stringify(t.value), Swal.fire({
                title: "All done!",
                html: "\n              Your answers:\n              <pre><code>".concat(t, "</code></pre>\n            "),
                confirmButtonText: "Lovely!"
            }))
        })
    }), $("#swal-12").on("click", function() {
        t.fire({
            icon: "success",
