...
function editRule(ruleId = null) {
    if (ruleId) {
        ...
        $.ajax({
            url: '../php_action/fetchSelectedBdcRule.php',
            type: 'post',
            data: { id: ruleId },
            dataType: 'json',
            success: function (response) {
                ...
                $('#editCalcFrom').val(response.calcfrom);
                $('#editCalculation').val(response.calculation);
                $('#editNumToCalc').val(response.num_to_calc);
    ...
    if (ruleId) {
        e1.fire({
            ...
            if (t.isConfirmed == true) {
                ...
                $.ajax({
                    url: '../php_action/removeBdcRule.php',
                    type: 'post',
                    data: { id: ruleId },
                    dataType: 'json',
                    success: function (response) {
