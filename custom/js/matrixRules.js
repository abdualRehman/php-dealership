...
$(function () {
    ...
    manageDataTable = $("#datatable-1").DataTable({
        responsive: !0,
        'ajax': '../php_action/fetchMatrixRules.php',
        dom: "Pfrtip",
        searchPanes: {
            cascadePanes: !0,
            viewTotal: !0,
...
function editRule(ruleId = null) {
    if (ruleId) {
        ...
        $.ajax({
            url: '../php_action/fetchSelectedMatrixRule.php',
            type: 'post',
            data: { id: ruleId },
            dataType: 'json',
            success: function (response) {
                ...
                // $('#editExModelno').val(response.ex_modelno);
    ...
    if (ruleId) {
        e1.fire({
            ...
            if (t.isConfirmed == true) {
                ...
                $.ajax({
                    url: '../php_action/removeMatrixRule.php',
                    type: 'post',
                    data: { id: ruleId },
                    dataType: 'json',
                    success: function (response) {
