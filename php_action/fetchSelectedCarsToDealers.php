...
inventory.stocktype , inventory.wholesale , inventory.id as invId , car_to_dealers.* FROM inventory LEFT JOIN car_to_dealers ON inventory.id = car_to_dealers.inv_id WHERE inventory.id = '$id'";
