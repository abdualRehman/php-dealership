...
$sql = "SELECT sale_incentives.* , users.username as sale_consultant , sales.date , sales.fname , sales.lname , inventory.stockno ,  inventory.stocktype , inventory.year , inventory.model , inventory.make , sales.state
