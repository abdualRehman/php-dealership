...
d.expire_in , d.dealer , d.other , d.lease FROM `manufature_price` as a LEFT JOIN rate_rule as b ON a.rate_rule_id = b.id  LEFT JOIN lease_rule as c ON a.lease_rule_id = c.id
