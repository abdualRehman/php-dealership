                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="zip" id="zip" placeholder="Zip" autocomplete="off" autofill="off" />
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="ezip" id="ezip" placeholder="Zip" autocomplete="off" autofill="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
