                                ...
                                <tr id="row1" class="0">
                                    <td class="form-group">
                                        <select class="form-control selectpicker w-auto" id="editModel" name="editModel" data-live-search="true" data-size="4">
                                            ...
                                            <option value="CIVIC SEDAN HYBRID">CIVIC SEDAN HYBRID</option>
                                            <option value="CIVIC HATCH">CIVIC HATCH</option>
                                            <option value="CIVIC HATCH HYBRID">CIVIC HATCH HYBRID</option>
