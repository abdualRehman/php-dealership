            ...
            <div class="col-12">
                <div class="portlet">
                    <div class="portlet-header portlet-header-bordered">
                        <h3 class="portlet-title">Matrix Rule List</h3>
                        <button class="btn btn-primary mr-2 p-2" onclick="toggleFilterClass()">
                            <i class="fa fa-align-center ml-1 mr-2"></i> Filter
                        </button>
                        <?php
                        if (hasAccess("matrixrule", "Add") !== 'false') {
...
<div class="modal fade" id="modal8">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="editRuleForm" action="../php_action/editMatrixRule.php" method="post">
                                    ...
                                    <tbody class="table-warning">
                                        <tr id="checkBoxRow">
                                            ...
                                            <th class="text-center">
                                                <input type="text" class="form-control" id="editDestination" name="editDestination" placeholder="Destination">
                                            </th>

                                            <th class="text-center">
                                                <input type="text" class="form-control" id="editHb" name="editHb" placeholder="Holdback">
                                            </th>
...
<div class="modal fade" id="addNew">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addNewRule" autocomplete="off" method="post" action="../php_action/createMatrixRule.php">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody class="table-warning">
                                    <tr id="checkBoxRow">
                                        ...
                                        <th class="text-center">
                                            <input type="text" class="form-control" id="hb" name="hb" placeholder="Holdback">
                                        </th>
